   ...
   .box{
    ...
    <body>
        ...
        <div class="container box">
            ...
            <form method="POST" action="{{ route('main.checklogin') }}">
                @csrf
                ...
                <div class="form-group">
                    <p class="text-danger" for="">If you do not have an account, please register first! <a href="{{ route('user.registration') }}">Click Here</a></p>
                </div>
                <div class="form-group">
...
<div class="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
    ...
    <div class="container-fluid text-center text-white border-top mt-4 py-4 px-sm-3 px-md-5"
        ...
        <p class="mb-2 text-white">Copyright &copy; <a class="font-weight-bold" href="#">Domain</a>. All Rights
            Reserved.</a></p>
        <p class="m-0 text-white">Designed by Rifah Tasnia Oeyshi</a></p>
    </div>
</div>
<!-- Footer End -->
